...
DATA_PATH = f"{folder_location}/data/Training.csv"
...
rf_model_path = Path(f'{folder_location}/prediction_model/{rf_model_file}')
gnb_model_path = Path(f'{folder_location}/prediction_model/{gnb_model_file}')
svm_model_path = Path(f'{folder_location}/prediction_model/{svm_model_file}')
...
description_file = f'{folder_location}/data/symptom_description.csv'
precaution_file = f'{folder_location}/data/symptom_precaution.csv'
